...
const ulasanBaru = computed(() => {
  return penjualStore.dashboardStats?.pesanan_baru || 0;
});
...
onMounted(async () => {
  ...
  await Promise.all([
    penjualStore.fetchProfile(),
    penjualStore.fetchDashboardStats(),
    produkStore.fetchAllProduk()
  ]);
});
          ...
          <div v-else>
            ...
            <div v-else>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-600 hover:shadow-lg transition-shadow duration-200">
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-sm text-gray-600 font-medium">Pesanan Baru</p>
                      <p class="text-3xl font-bold text-gray-900 mt-2">{{ ulasanBaru }}</p>
